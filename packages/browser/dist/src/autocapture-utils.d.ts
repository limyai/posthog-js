...
export declare function getMatchingSelector(elements: Element[], selectorList: string[] | undefined): string | undefined;
...
export declare function getElementAndParentsForElement(el: Element, captureOnAnyElement: false | true | undefined): {
